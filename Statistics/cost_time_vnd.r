...
legend <- c("RTEI","RTIE","STEI","STIE")

par(mar=c(5,6,4,1)+.1)
x <- barplot(execution.times.50,names.arg=legend,col="lightblue",main="Execution times on 50 jobs", ylab="Time (s)",ylim=c(0,50),cex.lab=2.5,cex.main=5,cex.axis=2,cex.names=2.5,width=c(0.1,0.1,0.1,0.1))
y <- as.matrix(execution.times.50)
text(x,y+3,labels=as.character(round(y,digits=2)),cex=4)

x <- barplot(execution.times.100,names.arg=legend,col="lightblue",main="Execution times on 100 jobs", ylab="Time (s)",ylim=c(0,1000),cex.lab=2.5,cex.main=5,cex.axis=2,cex.names=2.5)
y <- as.matrix(execution.times.100)
text(x,y+80,labels=as.character(round(y,digits=2)),cex=4)

x <- barplot(costs.50,names.arg=legend,col="lightblue",main="Percentage deviations for 50 jobs", ylab="Deviation (%)",ylim=c(0,3),cex.lab=2.5,cex.main=5,cex.axis=2,cex.names=2.5)
y <- as.matrix(costs.50)
text(x,y+0.2,labels=as.character(round(y,digits=2)),cex=4)

x <- barplot(costs.100,names.arg=legend,col="lightblue",main="Percentage deviations for 100 jobs", ylab="Deviation (%)",ylim=c(0,3),cex.lab=2.5,cex.main=5,cex.axis=2,cex.names=2.5)
